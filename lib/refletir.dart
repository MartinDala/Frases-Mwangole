...
class refletir extends StatefulWidget {
  @override
  _refletirState createState() => _refletirState();
}

class _refletirState extends State<refletir> {

  @override
  Widget build(BuildContext context) {
    return Scaffold(

      appBar: AppBar(title: Text("Frases para refletir"),backgroundColor:  Color(0xFF33A16C),
      ...
      body: Center(
        ...
        },future: DefaultAssetBundle.of(context).loadString("assets/refletir.json"),
        ),
